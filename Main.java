...
public class Main
{
	...
	public static void takeOrder() 
	{
        ...
        if (TacoStand.areTacosAvailable(option, numTacosOrdered)) {
            ...
            Main.printConfirmation(true, numTacosOrdered);  // Order was successful
        } else {
            Main.printConfirmation(false, 0);  // Order was unsuccessful
        }
    }
	 ...
	 * @param numTacos
	 */
    public static void printConfirmation(boolean orderSuccessful, int numTacos)
    {
        if (orderSuccessful) {
